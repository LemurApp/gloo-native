...
{
class MicrophoneDevice final : public IAudioSessionNotification, public IAudioSessionEvents
{
  MicrophoneDevice(DeviceManager* owner, const std::wstring& deviceId, CComPtr<IAudioSessionManager2> manager) : deviceId_(deviceId), manager_(manager), owner_(owner) {  }
...
public:
  ...
  static HRESULT Make(const std::wstring& deviceId, CComPtr<IMMDevice> &device, std::shared_ptr<MicrophoneDevice> &output, DeviceManager* owner);
  ...
  HRESULT STDMETHODCALLTYPE OnDisplayNameChanged(
      ...
      /* [in] */ LPCGUID EventContext) { return S_OK; }
  ...
  HRESULT STDMETHODCALLTYPE OnSessionDisconnected(
      /* [annotation][in] */
      _In_ AudioSessionDisconnectReason DisconnectReason) { return S_OK; }
